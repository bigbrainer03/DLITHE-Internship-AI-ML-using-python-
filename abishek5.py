...
#Qs 1
titanic_train=pd.read_csv('C:/Users/hp/Downloads/Titanic_train.csv')
titanic_test=pd.read_csv('C:/Users/hp/Downloads/Titanic_test.csv')
...
embark_mean_survived=titanic_train.groupby('Embarked')['Survived'].mean()
